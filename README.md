...
The GHCR image can be pulled directly. The v0.1.4 GitHub Release also includes a prebuilt Docker image archive for offline installation.

```bash
curl -L -o cass-sms-console-v0.1.4-docker-image.tar.gz \
  https://github.com/YonggangG/Cass-SMS-Console/releases/download/v0.1.4/cass-sms-console-v0.1.4-docker-image.tar.gz
gzip -dc cass-sms-console-v0.1.4-docker-image.tar.gz | docker load
```
